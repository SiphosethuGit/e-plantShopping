...
function ProductList({ onHomeClick }) {
    ...
    const [addedItems, setAddedItems] = useState({}); // Track which items are added to cart
    ...
    const isItemAdded = (plantName) => {
        return cartItems.some(item => item.name === plantName) || addedItems[plantName];
    };
            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        <img src="https://cdn.pixabay.com/photo/2020/08/05/13/12/eco-5465432_1280.png" alt="Logo" height="50px" />
                                ...
                                {category.plants.map((plant, plantIndex) => (
                                    <div key={plantIndex} className="plant-card">
                                        ...
                                        <div className="plant-details">
                                            ...
                                            <button 
                                                className={`add-to-cart-btn ${isItemAdded(plant.name) ? 'added' : ''}`}
                                                onClick={() => handleAddToCart(plant)}
                                                disabled={isItemAdded(plant.name)}
                                            >
                                                {isItemAdded(plant.name) ? '✓ Added to Cart' : 'Add to Cart'}
                                            </button>
                                        </div>
                                    </div>
                                ))}
